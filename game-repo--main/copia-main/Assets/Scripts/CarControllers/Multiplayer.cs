    ...
    public class Multiplayer : MonoBehaviour {
        ...
        public async Task QuickJoinLobby() {
            try {
                ...
                if (currentLobby != null && currentLobby.Data.TryGetValue(k_keyJoinCode, out var relayData)) {
                    ...
                    Debug.LogError("Failed to retrieve relay join code.");
                }
        ...
        async Task HandleHeartbeatAsync() {
            if (currentLobby == null) {
                Debug.LogError("No current lobby available for heartbeat.");
                return;
            }
        ...
        async Task HandlePollForUpdatesAsync() {
            if (currentLobby == null) {
                Debug.LogError("No current lobby available for polling updates.");
                return;
            }
